...
#define CONTRCURR_PID_KP		1.8
#define CONTRCURR_PID_KI		2.0
#define CONTRCURR_PID_KD		0.0
#define CONTRCURR_PID_D_DECAY		2.0

/* Current controller integral part limits. */
#define CONTRCURR_NEGLIM_I		AMPERE(-0.5)
#define CONTRCURR_POSLIM_I		AMPERE(0.5)
